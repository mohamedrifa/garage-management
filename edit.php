...
<!-- !PAGE CONTENT! -->
<div class="w3-main" style="margin-left:310px;margin-right:40px;width:80vw;">
  ...
  <hr style="width:235px;border:5px solid blue;margin-left:38%;transition:transfrom(-50%)" class="w3-round">
  <?php
$conn=mysqli_connect("localhost","root","","database");
	$sqli = "SELECT* FROM main where status='incomplete'";
    $resulti = mysqli_query($conn, $sqli);
		echo "<div class='container' style='width:75vw;'>";
    ...
    while($rowi = mysqli_fetch_assoc($resulti)) {
		...
		{			
	  echo "<tr >";
	  echo "<td>".$rowi['sno']."</td><td>" . $rowi['vehicle']. "</td><td>" . $rowi['too']. "</td><td>" . $rowi['date']. "</td>";
      echo "</tr>";
	  $var=1;
		}
		else
...
<tr><td></td><td>Enter the sno : </td><td><input type="text" name="sno"></td><td><input class="btn btn-success" style="background-color:lightblue;color:black;border:0px" type="submit" value="Click to continue"></td>
