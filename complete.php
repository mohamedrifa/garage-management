...
<div class="mduimage">
<img src="cars.png" align="middle" height="100" width="1000" style="border-radius:15px;"><br>
</div>
<br><br><br><br><br><br>
<header>
...
<button class="button" type="button" onclick="window.location.href='add1.php'">Add Vehicle</button>
</header>
<?php
session_start();
$a=$_SESSION["date"];
