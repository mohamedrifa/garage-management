...
<!-- !PAGE CONTENT! -->
<div class="w3-main" style="margin-left:340px;margin-right:40px;margin-top:120px"">

  <!-- Header -->
  <div class="w3-container" style="margin-top:120px" id="showcase">
	<img class="home-bg" src="head1.png" align="middle" height="100" width="900"><br>
...
$sqli = "SELECT* FROM company WHERE company='CARZONE'";
$resulti = mysqli_query($conn, $sqli);
$rowi = mysqli_fetch_assoc($resulti);
$c=$rowi['balance'];
$b=$b+$c;
    
		$q1="UPDATE `company` SET `balance`='".$b."' WHERE company='CARZONE'";
