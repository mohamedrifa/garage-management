...
<div class="container">
  <h1 align="left">View Accounts</h1>
    <hr style="width:250px;border:5px solid blue" class="w3-round">
...
<tr>	  
<td><input class="btn btn-success" style="background-color:lightblue;color:black;border:0px" type="submit"></td>		
</tr>
</tbody>
  </table>
  </form>
