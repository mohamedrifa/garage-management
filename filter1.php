...
$conn=mysqli_connect("localhost","root","","database");
	$sqli = "SELECT date,vehicle,company,too,advance,remark,advancetype,cashmode FROM main WHERE vehicle='".$a."'";
    $resulti = mysqli_query($conn, $sqli);
	echo "<center>";
echo '<div class="container" align="left" style="overflow:auto;">'; echo " <h1 align='center'>View Accounts</h1>";
  echo "<table class='table'>";
   ...
   while($rowi = mysqli_fetch_assoc($resulti)) {			
	  echo "<tr >";
	  echo "<td>".$rowi['date']."</td><td>".$rowi['vehicle']."</td><td>" . $rowi['too']. "</td><td>" . $rowi['remark']. "</td><td>" . $rowi['cashmode']. "</td>";
      echo "</tr>";
